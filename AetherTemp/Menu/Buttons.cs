    ...
    internal class Buttons
    {
        public static ButtonInfo[][] buttons = new ButtonInfo[][]
        {
            new ButtonInfo[] { // Main Mods
                ...
                new ButtonInfo { buttonText = "Movement", method =() => SettingsMods.advantages(), isTogglable = false, toolTip = "Opens the movement settings for the menu."},
                new ButtonInfo { buttonText = "Visuals", method =() => SettingsMods.movement(), isTogglable = false, toolTip = "Opens the projectile settings for the menu."},
                new ButtonInfo { buttonText = "Overpowered", method =() => SettingsMods.advantages(), isTogglable = false, toolTip = "Opens the movement settings for the menu."},
                new ButtonInfo { buttonText = "safety", method =() => SettingsMods.movement(), isTogglable = false, toolTip = "Opens the projectile settings for the menu."},
                new ButtonInfo { buttonText = "fun", method =() => SettingsMods.advantages(), isTogglable = false, toolTip = "Opens the movement settings for the menu."},
                new ButtonInfo { buttonText = "guardian", method =() => SettingsMods.movement(), isTogglable = false, toolTip = "Opens the projectile settings for the menu."},
            },
